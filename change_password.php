...
<body id="page-top">
  ...
  <h1 class="h3 mb-4 text-gray-800"><b>Change Password</b></h1>
        ...
        <div class="card-body">
		  ...
		  <div class="row form-group mb-5">
		    <div class="col-lg-6">
			  ...
			  <input type="password" name="new_password_confirm" value="" id="new_password_confirm" class="form-control"  />
			</div>
		  </div>
		  <hr>
		  <div class="row">
			<div class="col-lg-6 offset-6 text-right">
			  <input type="submit" name="btn_change" value="Change" id="btn_change" class="btn btn-primary mr-2"  />
			</div>
		  </div>
		  </form>		</div>
      </div>
